...
namespace LNDroneController.LND.LNURL
{
    ...
    public static class LNURLPayLogic
    {
        ...
        public static async Task<LNURLPayInvoiceResponse> BuildLNURLPayInvoiceResponse(this LNDNodeConnection node, long amount, string[,] originalMetadata, 
            string payerJsonData = null, int expiryInSeconds = 600)
        {
            ...
            var invoice = await node.LightningClient.AddInvoiceAsync(new Lnrpc.Invoice
            {
                ValueMsat = amount,
